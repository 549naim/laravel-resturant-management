...
-->
  ...
  <form action="{{url('orderconfirm')}}" method="post" enctype="multipart/form-data">
    @csrf
    <div  style="margin-top: 180px; right:50px">
        <table  class="table table" >
            <tbody>
             
              <tr>
                <th class="table-active">Food name</th>
                <th >price</th>
              ...
              <tr>
                ...
                {{$item->quantity}}</td>
                <td><img height="30" width="30"src="/foodimage/{{$item->image}}" alt="food"></td>
              ...
              @foreach ($data2 as $item)
                ...
                <td><a class="btn btn-danger" href="{{url('/deleteproduct',$item->id)}}">Delete</a></td>                          
    ...
    <div id="appear" style="padding:50px; align=center; display:none;" >
        <div>
        ...
        <br>
            ...
            <input style="background-color:rgb(48, 145, 33)" class="btn btn-primary" type="submit" value="Order Confirm">
         
            <button type="button" padding="5" id="closerbtn" class="btn btn-primary">cancel order</button>
    </div>
</form>
